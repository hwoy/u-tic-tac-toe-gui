...
CXX = g++
CXXFLAGS = -O2 -std=c++17 -pedantic -Wall -Wextra -I$(WX_INCLUDE_DIR) -I$(WX_SETUP_H_INCLUDE_DIR) -I$(TTT_DIR) -DDBUTTONCOLOR=wxColor$(DBUTTONCOLOR) -DP1COLOR=wxColor$(P1COLOR) -DP2COLOR=wxColor$(P2COLOR) -DBUILT_IN_VARS
