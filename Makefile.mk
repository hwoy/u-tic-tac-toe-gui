...
CXX = g++
CXXSTD = c++11 # c++11, c++14 , c++17
CXXWARNING = -Wall -Wextra
CXXFLAGS = -O2 -std=$(CXXSTD) -pedantic $(CXXWARNING) -I$(WX_INCLUDE_DIR) -I$(WX_SETUP_H_INCLUDE_DIR) -I$(TTT_DIR) -DDBUTTONCOLOR=wxColor$(DBUTTONCOLOR) -DP1COLOR=wxColor$(P1COLOR) -DP2COLOR=wxColor$(P2COLOR) -DBUILT_IN_VARS
